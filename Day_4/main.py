...
from nodes import llm_router_node, city_info_node, flight_info_node, weather_info_node, budget_planner_node, itinerary_node
...
def build_graph():
    ...
    graph_builder.add_edge("budget_planner_node", "itinerary_node")
